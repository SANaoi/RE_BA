...
namespace KSG
{
    ...
    {
        private const string DataRowClassPrefixName = "KSG.DR";
        ...
        public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName, object userData = null)
        {
            ...
            dataTable.ReadData(AssetUtility.GetDataTableAsset(dataTableName, false), Constant.AssetPriority.DataTableAsset, userData);
        }
